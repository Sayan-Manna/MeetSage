-- MeetSage Database Schema
-- Auto-run by Docker on first start via docker-entrypoint-initdb.d
...
CREATE INDEX idx_analyses_meeting_id  ON meeting_analyses(meeting_id);

-- Note: Spring AI PgVectorStore auto-creates its own vector_store table.
-- No need to manually create transcript_chunks or embedding tables.
